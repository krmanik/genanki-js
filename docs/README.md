...
#### 1. Download `genanki.js` from  [dist](https://github.com/krmanik/genanki-js/tree/main/dist) folder and add to the project
...
>Note: The `SQL` variable is used in [package.js#L20](https://github.com/krmanik/genanki-js/blob/main/genanki/package.js#L20).
